...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        var bodyScroll = wind.scrollTop(),
            ...
            kontakt = $(".navbar.change .social-icon img");

        if (bodyScroll > 300) {

            navbar.addClass("nav-scroll");
            logo.attr('src', 'https://test.znojmoreklama.cz/src/assets/img/logo-dark.svg');
            kontakt.attr('src', 'https://test.znojmoreklama.cz/src/assets/img/icons/email-black.svg');

        } else {

            navbar.removeClass("nav-scroll");
            logo.attr('src', 'https://test.znojmoreklama.cz/src/assets/img/logo-light.svg');
            kontakt.attr('src', 'https://test.znojmoreklama.cz/src/assets/img/icons/email-white.svg');
        }
    });
